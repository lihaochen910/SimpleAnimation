...
public class SimpleAnimationEditor : Editor
{
    static class Styles
    {
        ...
        public static GUIContent animations = new GUIContent("Animation Group", "These clips will define the States the component will start with");
    ...
    void OnEnable()
    {
        ...
        states = serializedObject.FindProperty("m_AnimationGroup");
